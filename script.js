                ...
                data.meals.forEach(meal => {
                    ...
                    <div class="card mb-3">
                        ...
                        <h4>Category: <span>${meal.strCategory}</span></h4>
                            ...
                            <p class="card-text text-center" style="width: 70%;margin:auto;padding-bottom: 30px; font-size:20px;font-weight:bold;">Details: <span style="font-size:15px;font-weight:400;">${meal.strInstructions}</p>
